...
UninstallDisplayName=Prova
Uninstallable=true

[Files]
Source: "pkg\windows\PathMgr.dll"; DestDir: "{app}"; Flags: uninsneveruninstall
Source: "target\release\prova.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; Archetype rendering clones Git repos; long paths must be enabled for Git too.
[Run]
