...
prova.test("polls a function subject until the matcher passes", { spec = "api-freeze §4 - :eventually" }, function(t)
  local n = 0
  t:expect(function()
    n = n + 1
    return n
...
prova.test("the k8s idiom — eventually matches a structural subset", { spec = "api-freeze §4 - :eventually" }, function(t)
  local polls = 0
  t:expect(function()
    polls = polls + 1
...
prova.test("opts are optional — retry defaults apply", { spec = "api-freeze §4 - :eventually" }, function(t)
  local flipped = false
  t:expect(function()
    local was = flipped
    flipped = true
...
prova.test("a non-function subject is a clear error, not a silent one-shot", { spec = "api-freeze §4 - :eventually" }, function(t)
