...
prova.test("base64 encodes and decodes, round-tripping binary-ish text", function(t)
  t:expect(base64.encode("prova")):equals("cHJvdmE=")
  t:expect(base64.decode("cHJvdmE=")):equals("prova")
end)

prova.test("hash.sha256 hex-digests the NIST vector", function(t)
  t:expect(hash.sha256("abc"))
    :equals("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad")
end)

prova.test("hash.hmac_sha256 is keyed and deterministic", function(t)
...
prova.test("uuid.v4 emits distinct RFC-shaped ids", function(t)
  local id = uuid.v4()
...
prova.test("url.parse exposes the structured parts", function(t)
...
prova.test("url.encode percent-encodes a component", function(t)
