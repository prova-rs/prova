-- In a build WITHOUT the kafka feature, `kafka` is an absent-namespace stub: accessing a field
...
prova.test("absent namespace raises a clear error", function(t)
  local ok, err = pcall(function() return kafka.client("localhost:9092") end)
